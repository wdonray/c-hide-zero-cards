...
export function DraggableCard({
  ...
  return (
    <div
      ref={dragRef}
      className={`flex items-center justify-center gap-0 px-5 py-10 text-6xl font-bold border border-border cursor-move select-none tracking-[22px] tabular-nums text-white ${cardColor(placeValue)}`}
      style={{
        position: 'absolute',
